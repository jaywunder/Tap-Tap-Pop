...
var thickness = two.width / 50; // 20 // two.width > two.height ? two.width / 50 : two.height / 50
...
var smallCircle = two.makeEllipse(centerX - centerRadius, centerY, thickness * 0.6, thickness * 0.6);
